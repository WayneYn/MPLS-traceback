...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='f' && strcmp(fieldName, "forwardLabel")==0) return base+1;
    if (fieldName[0]=='t' && strcmp(fieldName, "traceLabel")==0) return base+2;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Packet *pp = (Packet *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getDestAddr());
        case 1: return long2string(pp->getForwardLabel());
        case 2: return long2string(pp->getTraceLabel());
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Packet *pp = (Packet *)object; (void)pp;
    switch (field) {
        case 0: pp->setDestAddr((value)); return true;
        case 1: pp->setForwardLabel(string2long(value)); return true;
        case 2: pp->setTraceLabel(string2long(value)); return true;
